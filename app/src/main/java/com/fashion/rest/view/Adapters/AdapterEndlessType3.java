...
public class AdapterEndlessType3 extends RecyclerView.Adapter<BaseViewHolderUser> {
  ...
  public AdapterEndlessType3(List<Deal> postItems, Context context, String comeFrom) {
    ...
    switch (viewType) {
      case VIEW_TYPE_NORMAL:
        return new ViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_typ3_endless, parent, false));
