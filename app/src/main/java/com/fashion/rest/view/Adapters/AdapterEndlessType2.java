...
public class AdapterEndlessType2 extends RecyclerView.Adapter<BaseViewHolderUser> {
  ...
  public AdapterEndlessType2(List<Deal> postItems, Context context, String comeFrom) {
    ...
    switch (viewType) {
      case VIEW_TYPE_NORMAL:
        return new ViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_typ2_endless, parent, false));
