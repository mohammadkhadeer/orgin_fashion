...
import static com.fashion.rest.functions.Functions.fillRingsArrayL;
...
public class FragmentRings extends Fragment implements AdapterSet.PassItem{
    ...
    private void createRVSuggested() {
        dealsArrayList = fillRingsArrayL(dealsArrayList,getActivity());
        ...
        adapterSet =new AdapterSet(getActivity()
                ,dealsArrayList,getActivity().getResources().getString(R.string.rings_s),this);
