...
public class SliderAdapter extends
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        viewHolder.per_adapter_4.setText(calculatePercentage(sliderItem.getPrice(),sliderItem.getDiscountPrice()));
    ...
    private void fillText(SliderAdapterVH viewHolder, Context context, ItemTest sliderItem) {
        viewHolder.nameTV.setText(getTextEngOrLocal(context,sliderItem.getName(),sliderItem.getName_local()));
        viewHolder.store_name.setText(getTextEngOrLocal(context,sliderItem.getStore().getName(),sliderItem.getStore().getName_local()));
        viewHolder.textViewDescription.setText(getTextEngOrLocal(context,sliderItem.getDescription(),sliderItem.getDescription_local()));
    ...
    private void fillStoreImage(SliderAdapterVH viewHolder, ItemTest sliderItem) {
        Glide.with(viewHolder.itemView)
                .load(apiURLBase()+sliderItem.getStore().getFlag().getUrl())
                .fitCenter()
    ...
    private void fillItemImage(SliderAdapterVH viewHolder, ItemTest sliderItem) {
        Glide.with(viewHolder.itemView)
                .load(apiURLBase()+sliderItem.getFlagArrayL().get(0).getUrl())
                .fitCenter()
