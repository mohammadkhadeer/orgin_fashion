...
import com.orgin_fashion.rest.model.Flag;
import com.orgin_fashion.rest.presnter.JsonPlaceHolderApi;
import com.orgin_fashion.rest.view.Adapters.AdapterCountries;
    ...
    private void timer() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                {
                    Intent intent = new Intent(getActivity(), com.orgin_fashion.rest.view.activity.Language.class);
