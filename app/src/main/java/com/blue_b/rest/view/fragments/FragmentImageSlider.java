...
import com.blue_b.rest.view.Adapters.SlidingImage_Adapter;
...
public class FragmentImageSlider extends Fragment implements SlidingImage_Adapter.ImageClicked {
    ...
    public void onAttach(Context context) {
        if (getArguments() != null) {
            ...
            itemIV = Functions.getTextEngOrLocal(getActivity(),itemTest.getName(),itemTest.getName_local());
            cat = Functions.getTextEngOrLocal(getActivity(),itemTest.getSub_cat().getName_en(),itemTest.getSub_cat().getName_local());
