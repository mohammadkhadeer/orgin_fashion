...
import com.blue_b.rest.sharedPreferences.Country;
...
public class Setting extends AppCompatActivity {
    ...
    private void fillLoginOrLogout() {
        if (LoginInfo.getLoginOrNotFromSP(getApplicationContext()).isEmpty())
        {
        ...
        setting_log_out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (LoginInfo.getLoginOrNotFromSP(getApplicationContext()).isEmpty())
                {
                    ...
                    LoginInfo.cleanLogin(getApplicationContext());
                    moveToSplashScreen();
                }
            }
        });
    ...
    private void fillCountry() {
        setting_country_TV.setText(Country.getCountryFromSP(this));
        Picasso.get()
                .load(Country.getCountryUrlFromSP(this))
                .fit()
                .centerCrop()
