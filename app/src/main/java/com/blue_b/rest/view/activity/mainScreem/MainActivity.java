...
import com.blue_b.rest.view.fragments.fragmentHomeMainScreen.FragmentHomeScreen;
import com.blue_b.rest.view.fragments.fragmentHomeMainScreen.FragmentNotification;
import com.blue_b.rest.view.fragments.fragmentHomeMainScreen.FragmentProfile;
...
import com.blue_b.rest.view.fragments.fragmentHomeMainScreen.PopUpCategory;
...
import static com.blue_b.rest.functions.FunctionCart.updateNumberOfItemInCartAndInsertToDataBase;
...
public class MainActivity extends AppCompatActivity implements PassObject
    ...
    public static void setLocale(Activity context) {
        ...
        locale = new Locale(Language.getLanguageFromSP(context));
    ...
    private void BottomBarMenu() {
        ...
        int num = Functions.notificationNumber(this);
        if(num >0 && num != -1)
    ...
    private boolean switchFragment(int tabId) {
        switch (tabId) {
            ...
            case R.id.tab_notifications:
                ...
                NumberOfNotification.cleanNotifications(this);
