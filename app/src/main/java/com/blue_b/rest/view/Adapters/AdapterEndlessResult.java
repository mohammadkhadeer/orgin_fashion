...
import static com.blue_b.rest.view.Adapters.resultTupe1.FillResultsType1.fillItemCase1;
  ...
  public class ViewHolder extends BaseViewHolderUser {
    ...
    public void onBind(int position) {
      ...
      if(getObject(position).getCustomItems().size() ==1)
      {
        ...
        Functions.checkFavOrNot(getObject(position).getCustomItems().get(0).getId(),context,fav_or_not_result1);
        Functions.actionListenerToFav(getObject(position).getCustomItems().get(0).getId(),getObject(position).getCustomItems().get(0).getSub_cat().getId()
        ...
        Functions.checkFavOrNot(getObject(position).getCustomItems().get(1).getId(),context,fav_or_not_result2);

        Functions.actionListenerToFav(getObject(position).getCustomItems().get(1).getId(),getObject(position).getCustomItems().get(1).getSub_cat().getId()
